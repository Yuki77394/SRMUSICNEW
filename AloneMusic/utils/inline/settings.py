...
def vote_mode_markup(_, current, mode: Union[bool, str] = None):
    buttons = [
        [
            InlineKeyboardButton(text="⌯ ᴠᴏᴛɪɴɢ ϻᴏᴅє ➜ ⌯", callback_data="VOTEANSWER"),
...
def playmode_users_markup(
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton(text=_["ST_B_15"], callback_data="AUTOPLAYANSWER"),
            InlineKeyboardButton(
        ...
        [
            InlineKeyboardButton(text=_["ST_B_16"], callback_data="THUMBNAILANSWER"),
            InlineKeyboardButton(
